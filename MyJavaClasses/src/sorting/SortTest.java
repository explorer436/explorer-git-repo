...
public class SortTest
{
	...
	public static void main(String[] arg)
	{
		...
		System.out.println("Average sorting time: " + sortTime + " milliseconds");
	...
	public static void printTimeInfo(long t, int n)
	{
		...
		System.out.println("Performance: " + nFactor + " O(N) nanoseconds");
		System.out.println("Performance: " + ngFactor + " O(N*Log2(N)) nanoseconds");
		System.out.println("Performance: " + nnFactor + " O(N*N) nanoseconds");
	}
