...
*** Deleting
   ...
   * How to delete whitespace in blank lines?
   ...
   How to remove duplicate rows in vi :sort u
   ...
   ---------------------------------------------------------------------------
   How to delete line containing certain text in vim with prompt :%s/.*text.*\n//gc
   ...
   How to delete text between all braces {} in vim?
